...
use Incrootal\Migration\Helpers\Traits\UserOptions\HlblockTrait;
use Incrootal\Migration\Helpers\Traits\UserOptions\IblockTrait;
use Incrootal\Migration\Helpers\Traits\UserOptions\UserGroupTrait;
use Incrootal\Migration\Helpers\Traits\UserOptions\UserTrait;
...
class UserOptionsHelper extends Helper
{
    ...
    /**
     * Экспортирует форму смарт-процесса
     *
     * @param int $smartProcessId
     * @return array
     * @throws HelperException
     */
    public function exportSmartProcessForm($smartProcessId)
    {
        return $this->exportForm([
            'name' => 'smartprocess_form_' . $smartProcessId,
            'category' => 'smartprocess_form',
        ]);
    }

    /**
     * Экспортирует список смарт-процесса
     *
     * @param int $smartProcessId
     * @return array
     * @throws HelperException
     */
    public function exportSmartProcessList($smartProcessId)
    {
        return $this->exportList([
            'name' => 'smartprocess_list_' . $smartProcessId,
            'category' => 'smartprocess_list',
        ]);
    }
    /**
     * @param array $formData
