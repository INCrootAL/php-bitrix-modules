...
use Exception;
use Incrootal\Migration\Builders\AgentBuilder;
use Incrootal\Migration\Builders\BlankBuilder;
use Incrootal\Migration\Builders\CacheCleanerBuilder;
use Incrootal\Migration\Builders\EventBuilder;
use Incrootal\Migration\Builders\FormBuilder;
use Incrootal\Migration\Builders\HlblockBuilder;
use Incrootal\Migration\Builders\HlblockElementsBuilder;
use Incrootal\Migration\Builders\IblockBuilder;
use Incrootal\Migration\Builders\IblockCategoryBuilder;
use Incrootal\Migration\Builders\IblockElementsBuilder;
use Incrootal\Migration\Builders\MarkerBuilder;
use Incrootal\Migration\Builders\MedialibElementsBuilder;
use Incrootal\Migration\Builders\OptionBuilder;
use Incrootal\Migration\Builders\SmartProcessBuilder;
use Incrootal\Migration\Builders\TransferBuilder;
use Incrootal\Migration\Builders\UserGroupBuilder;
use Incrootal\Migration\Builders\UserOptionsBuilder;
use Incrootal\Migration\Builders\UserTypeEntitiesBuilder;
use Incrootal\Migration\Builders\WorkFlowTemplateBuilder;
use Incrootal\Migration\Enum\EventsEnum;
use Incrootal\Migration\Enum\VersionEnum;
use Incrootal\Migration\Exceptions\MigrationException;
use Incrootal\Migration\Schema\AgentSchema;
use Incrootal\Migration\Schema\EventSchema;
use Incrootal\Migration\Schema\GroupSchema;
use Incrootal\Migration\Schema\HlblockSchema;
use Incrootal\Migration\Schema\IblockSchema;
use Incrootal\Migration\Schema\OptionSchema;
use Incrootal\Migration\Schema\UserTypeEntitiesSchema;
...
class VersionConfig
{
    ...
    public static function getDefaultBuilders()
    {
        return [
            ...
            'SmartProcessBuilder'     => SmartProcessBuilder::class,
