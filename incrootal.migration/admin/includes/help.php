    ...
    <div class="sp-row2">
        ...
        <div class="sp-col">
            <div style="margin-bottom: 10px;">
                ...
                <a href="http://marketplace.1c-bitrix.ru/solutions/incrootal.migration/" target="_blank">http://marketplace.1c-bitrix.ru/solutions/incrootal.migration/</a>
            </div>
            <div style="margin-bottom: 10px;">
                <?= Locale::getMessage('LINK_COMPOSER') ?>
                <br/>
                <a href="https://packagist.org/packages/andreyryabin/incrootal.migration" target="_blank">https://packagist.org/packages/andreyryabin/incrootal.migration</a>
            </div>
            <div style="margin-bottom: 10px;">
                <?= Locale::getMessage('LINK_DOC') ?>
                <br/>
                <a href="https://github.com/andreyryabin/incrootal.migration/wiki" target="_blank">https://github.com/andreyryabin/incrootal.migration/wiki</a>
            </div>
            <div style="margin-bottom: 10px;">
