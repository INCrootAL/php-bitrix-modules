...
if (isset($_REQUEST['schema'])) {
    $versionConfig = new Incrootal\Migration\VersionConfig($_REQUEST['schema']);
} elseif (isset($_REQUEST['config'])) {
    $versionConfig = new Incrootal\Migration\VersionConfig($_REQUEST['config']);
} else {
    $versionConfig = new Incrootal\Migration\VersionConfig();
}
