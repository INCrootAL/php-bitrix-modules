...
\Incrootal\Migration\Locale::loadLocale(
    "ru",
    [
        ...
        "PARTNER_URI"              => "https://packagist.org/packages/andreyryabin/incrootal.migration",
...
\Incrootal\Migration\Locale::loadLocale(
    "ru",
    [
        "BUILDER_SmartProcessExport1"                => "Создать миграцию для смарт-процесса",
        "BUILDER_SmartProcessExport2"                        => implode(PHP_EOL, [
            "Задайте символьные коды у смарт-процессов, чтобы увидеть их в списке",
        ]),
      /*  "BUILDER_SmartProcessExport2"                => "Задайте символьные коды у смарт-процессов, чтобы увидеть их в списке",*/
        "BUILDER_SmartProcessExport_SmartProcessId"  => "Выберите смарт-процессы",
        "BUILDER_SmartProcessExport_What"            => "Что переносим",
        "BUILDER_SmartProcessExport_WhatSmartProcess"        => "Смарт-процесс",
        "BUILDER_SmartProcessExport_WhatSmartProcessFields"  => "Поля смарт-процесса",
        "BUILDER_SmartProcessExport_WhatSmartProcessTransferStages" => "Перенос стадий",
        "BUILDER_SmartProcessExport_WhatSmartProcessTransferFunnels" => "Перенос воронок",
        /*"BUILDER_SmartProcessExport_WhatSmartProcessBusinessProcesses" => "Бизнес процессы",*/
        "BUILDER_SmartProcessExport_WhatSmartProcessUserOptions" => "Настройки формы редактирования и списка",
        "BUILDER_SmartProcessExport_WhatSmartProcessPermissions" => "Доступ к смарт-процессу",
    ]
);
...
/*\Incrootal\Migration\Locale::loadLocale(
    "ru",
    [
        "BUILDER_WorkFlowTemplateExport1"                => "Создать миграцию для бизнес процессов",
        "BUILDER_WorkFlowTemplateEntities"                => "Выберите сущность и смарт процессы",
...
\Incrootal\Migration\Locale::loadLocale(
    ...
    [
        ...
        "BUILDER_GROUP_SmartProcess" => "Смарт-процессы",
        /*"BUILDER_GROUP_WorkFlowTemplate" => "CRM",*/
    ]
);
